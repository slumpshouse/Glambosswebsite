...
function buildEditableSummary(structured) {
  return [
    structured.headline,
    "",
    structured.summary,
...
async function generateStructuredSummary(aggregate) {
